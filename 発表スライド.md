...
欠点:
- 話者識別も可能だが精度がいまいち
  → 男性2人の会話であるため基本周波数が近いため(フォルマントも近い？)識別がうまくいかなかったかも
  → 対話人数を指定する必要があるため本格的に使用するためには画像(動画)認識で対話人数を取得するか指定するしかない
